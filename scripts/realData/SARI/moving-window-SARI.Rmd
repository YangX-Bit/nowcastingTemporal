...
"
  ...
  for (i in seq_len(nrow(df))) {
    ...
    vals <- c(
      hl(row$RMSE_baseline2,  row$RMSE_proposed,  mode = "smaller"),
      hl(row$RMSPE_baseline2, row$RMSPE_proposed, mode = "smaller"),
      hl(row$crps_baseline2,  row$crps_proposed,  mode = "smaller"),
      hl(row$mcr95_baseline2, row$mcr95_proposed, mode = "closer", target = 0.95),
      hl(row$mcr50_baseline2, row$mcr50_proposed, mode = "closer", target = 0.5)
    )

...
gt = read.csv("/Users/xiaoy0a/Desktop/GitHub/Dengue/dengue-tracker/data/weekly_data/gtrends/202452/RJ_trends.csv", stringsAsFactors = FALSE, skip = 2)[,c(-4)]
...
stan_data <- c(list(T = ind, D = 15, Y = rj_delay_matrix,
                    K = 1, X = scale(log(covars_matrix[,1]))), hypers)

...
arabm <- extract_N_summary(results1, num_N = 6)
arabm_wGT <- extract_N_summary(results_wGT1, num_N = 6, model_name = "ARABMwGT")

results1 <- tail(results,10)
results_wGT1 <- tail(results_wGT,10)
print("done")
```

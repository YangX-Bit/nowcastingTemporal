...
alpha_noise <- 2
beta_noise <- 0.05
noise_sd <- alpha_noise + beta_noise * (seasonal + outbreak)
covariate_raw <- seasonal + outbreak + rnorm(T, mean = 0, sd = noise_sd)
...
beta_t <- scale_to_range(beta_t, 0.6, 0.8)
...
raw_log_lambda <- beta0 + beta_t * ZT + eta

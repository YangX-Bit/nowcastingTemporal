...
param_true = tibble(
    parameter = grep("^b\\[.+\\]$", varnames_GT[[3]], value = TRUE),
    x = b_ou_FR$b[1:ind[3]]
)
...
param_true = tibble(
    parameter = grep("^phi\\[.+\\]$", varnames_GT[[3]], value = TRUE),
    x = 1 - b_ou_FR$phi[1:ind[3]]
)
mcmc_areas(test_GT$draws("phi"), prob_outer = 0.95) +
    geom_point(aes(x = x), param_true, color = "red", size = 1)

param_true = tibble(
    parameter = grep("^lambda\\[.+\\]$", varnames_GT[[3]], value = TRUE),
    x = b_ou_FR$lambda[1:ind[3]]
)
mcmc_areas(test_GT$draws("lambda"), prob_outer = 0.95) +
    geom_point(aes(x = x), param_true, color = "red", size = 1)

param_true = tibble(
    parameter = grep("^q\\[10,.+\\]$", varnames_GT[[3]], value = TRUE),
    x = b_ou_FR$q[10,]
)
mcmc_areas(test_GT$draws(grep("^q\\[10,.+\\]$", varnames_GT[[3]], value = TRUE)), prob_outer = 0.95) +
    geom_point(aes(x = x), param_true, color = "red", size = 1)

param_true = tibble(
    parameter = grep("^N\\[.+\\]$", varnames_GT[[3]], value = TRUE),
    x = b_ou_FR$case_true[1:ind[3], 1]
)
mcmc_areas(test_GT$draws("N"), prob_outer = 0.95) +
    geom_point(aes(x = x), param_true, color = "red", size = 1)

param_true = tibble(
    parameter = grep("^beta_t\\[.+\\]$", varnames_GT[[3]], value = TRUE),
    x = beta_t_true[1:ind[3]]
)
...
param_true = tibble(
    parameter = grep("^s_t\\[.+\\]$", varnames_GT[[3]], value = TRUE),
    x = s_t[1:ind[3]]
)
mcmc_areas(test_GT$draws("s_t"), prob_outer = 0.95) +
    geom_point(aes(x = x), param_true, color = "red", size = 1)
```

...
params_b_ou_NFR <- list(
  ...
  q_model = list(
    method        = "b_ou",
    method_params = list(theta_logb = 0.4, mu_logb = log(0.05), init_logb = log(0.05), sigma_logb = 0.4,
                         theta_logitphi = 0.4, mu_logitphi = -3, init_logitphi = -3, sigma_logitphi = 0.15)

...
```{r}
  ...
  tau_x <- 10      # information level for x
  tau_s <- 50        # for s
...
params_b_ou_NFR <- list(
  ...
  q_model = list(
    ...
    method_params = list(theta_logb = 0.7, mu_logb = log(0.05), init_logb = log(0.05), sigma_logb = 0.4,
                         theta_logitphi = 0.7, mu_logitphi = inverse_logistic_transform(0.1, 0, 1), init_logitphi = inverse_logistic_transform(0.1, 0, 1), sigma_logitphi = 0.15)
  )
)
